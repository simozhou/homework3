...
class TimeTest(object):
    ...
    def test_it(self):
        ...
        for bst_key in self.array_pool[DEFAULT_NUMBER]:
            ...
            if insertion_counter in self.array_pool.keys():
                ...
                # KEY, VALUE
                tree.put(bst_key, 0)
        print("binary insertion, get random, get max timing done!")
        ...
        print("heap insertion timing done!")
    ...
    def _test_it_binary_get_max(self, key):
        self.test_result['binary_get_max'][key] = timeit.timeit("tree.findMax()", globals=globals(), number=100)
